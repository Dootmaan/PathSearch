...
parser.add_argument('--data_dir', type=str, default='./data/DHMC_LUAD')
...
if params.sample_num == -1:
    dataset = DHMCLUADDataset(path=params.data_dir, mode='test', sample_num=None)
else:
    dataset = DHMCLUADDataset(path=params.data_dir, mode='test', sample_num=params.sample_num)
